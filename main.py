...
# копируем файлы/папки (из папки app) в корень нового проекта
...
folder_from = os.path.join(os.path.abspath(os.curdir), 'app')
...
# ________Закрываем текущий проект и переходим в файл main.py в новом проекте_______________
